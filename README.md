...
Facilitator init can be also be done with `--gateway-config <gateway-config>` option. Refer [here](https://github.com/mosaicdao/mosaic-chains#gateway-config ) to locate gateway config.
