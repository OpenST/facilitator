...
class WithdrawIntentModel extends Model {
  ...
  export default class WithdrawtentRepository extends Subject<WithdrawIntent> {
    /* Public Functions */
    ...
    private convertToWithdrawIntent(withdrawIntentModel: WithdrawIntentModel): WithdrawIntent {
        return new WithdrawIntent(
          ...
          withdrawIntentModel.amount ? new BigNumber(withdrawIntentModel.amount) : withdrawIntentModel.amount,
