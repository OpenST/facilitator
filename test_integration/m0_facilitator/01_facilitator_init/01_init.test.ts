...
describe('facilitator init', async (): Promise<void> => {
  ...
  const mosaicConfigPath = path.join(__dirname, '../../../testdata/m0_facilitator/mosaic.json');
  const gatewayConfigPath = path.join(__dirname, '../../../testdata/m0_facilitator/0xae02c7b1c324a8d94a564bc8d713df89eae441fe.json');
